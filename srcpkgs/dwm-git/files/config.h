...
static const char *dmenucmd[] = { "drun", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static const char *aswitchcmd[] = { "aswitch.sh", NULL};
static const char *brightupcmd[] = { "xbacklight", "-inc", "10", NULL };
static const char *brightdowncmd[] = { "xbacklight", "-dec", "10", NULL };
/* static const char *batterycmd[] = { NULL }; */
/* static const char *displaycmd[] = { NULL }; */
/* static const char *sleepcmd[] = { "slock", "sudo /usr/bin/zzz", NULL }; */
...
static Key keys[] = {
	...
	{ MODKEY,        XF86XK_AudioMute,         spawn,          {.v = aswitchcmd} },
	{ 0,             XF86XK_MonBrightnessUp,   spawn,          {.v = brightupcmd} },
	{ 0,             XF86XK_MonBrightnessDown, spawn,          {.v = brightdowncmd} },
	/* { NULL,          XF86XK_Battery,           spawn,          {.v = batterycmd} }, */
	/* { NULL,          XF86XK_Display,           spawn,          {.v = displaycmd} }, */
	/* { 0,             XF86XK_Sleep,             spawn,          {.v = sleepcmd} }, */
	{ 0,             XF86XK_HomePage,          spawn,          {.v = browsercmd} },

	{ MODKEY,                       XK_F6,     spawn,          {.v = mediapreviouscmd } },
	{ MODKEY,                       XK_F7,     spawn,          {.v = medianextcmd } },
	{ MODKEY,                       XK_F8,     spawn,          {.v = mediaplaypause } },
